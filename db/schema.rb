...
ActiveRecord::Schema[7.1].define(version: 2024_02_12_151113) do
  ...
  create_table "breed_sellers", force: :cascade do |t|
    t.bigint "breed_id", null: false
    t.bigint "seller_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["breed_id"], name: "index_breed_sellers_on_breed_id"
    t.index ["seller_id"], name: "index_breed_sellers_on_seller_id"
  end
  ...
  add_foreign_key "breed_sellers", "breeds"
